...
# -*- coding: utf-8 -*-
"""
Created on Wed May  8 18:09:53 2024
...
# Definición de hiperparámetros para RandomForestClassifier
param_grid = {
...
for train_index, test_index in skf.split(X, Y):
    ...
    rf_grid = GridSearchCV(RandomForestClassifier(random_state=42), param_grid, cv=3, n_jobs=-1, scoring='f1_macro')
    ...
    result = permutation_importance(random_forest, X_test_scaled, Y_test, n_repeats=10, random_state=42, n_jobs=-1)
