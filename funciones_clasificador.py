...
# -*- coding: utf-8 -*-
"""
Created on Wed May  1 13:16:14 2024
...
def prepare_data():
    ...
    df_hsa = pd.read_excel('/Users/elenamartineztorrijos/Desktop/TFG/Data List HSA.xlsx', usecols=['Patient', 'IVH', 'Bleed', 'Supraselar cistern bleed', 'Fisher Modified Scale  (neuroradiologist 1)'], sheet_name='Hoja5')
    
    #df_hemorrhage = pd.read_excel('/Users/elenamartineztorrijos/Desktop/TFG/Results_model_seg.xlsx', usecols=['Patient', 'Total Volume (ml)', 'Section (0, 1)', 'Section (0, 2)', 'Section (0, 3)', 'Section (1, 1)', 'Section (1, 2)', 'Section (1, 3)', 'Section (1, 4)', 'Section (2, 0)', 'Section (2, 1)', 'Section (2, 2)', 'Section (2, 3)', 'Section (2, 4)', 'Section (3, 0)', 'Section (3, 1)', 'Section (3, 2)', 'Section (3, 3)', 'Section (4, 1)', 'Section (4, 2)', 'Section (4, 3)', 'Hemorrhage in Column 2'])
