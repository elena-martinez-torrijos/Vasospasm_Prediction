...
# -*- coding: utf-8 -*-
"""
Created on Tue May  7 14:56:09 2024
...
for index, row in df.iterrows():
    ...
    max_thickness = 0  # Inicializamos el grosor máximo de la rebanada
    ...
    for series_part in series_parts:
        ...
        current_thickness = 0  # Inicializamos el grosor actual de la rebanada
    ...
    results.append({
        ...
        'Max_Slice_Thickness': max_thickness,
    })
...
result_excel_file = '/Users/elenamartineztorrijos/Desktop/TFG/Max_Slice_Thickness_results2.xlsx'
